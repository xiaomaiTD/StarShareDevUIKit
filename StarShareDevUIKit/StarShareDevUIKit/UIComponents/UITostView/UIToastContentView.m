...
@interface UIToastContentView (UIAppearance)

@end

@implementation UIToastContentView (UIAppearance)
...
+ (void)setDefaultAppearance {
  UIToastContentView *appearance = [UIToastContentView appearance];
