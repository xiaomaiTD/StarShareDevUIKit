//
//  UICollectionViewPagingLayout.m
//  Project
//
...
@implementation UICollectionViewPagingLayout (ScaleStyle)
...
const CGFloat UICollectionViewPagingLayoutRotationRadiusAutomatic = -1.0;

@implementation UICollectionViewPagingLayout (RotationStyle)
...
- (instancetype)initWithStyle:(UICollectionViewPagingLayoutStyle)style {
  if (self = [super init]) {
    _style = style;
    ...
    self.rotationRadius = UICollectionViewPagingLayoutRotationRadiusAutomatic;
...
- (instancetype)init {
  return [self initWithStyle:UICollectionViewPagingLayoutStyleDefault];
}
...
- (BOOL)shouldInvalidateLayoutForBoundsChange:(CGRect)newBounds {
  if (self.style == UICollectionViewPagingLayoutStyleScale || self.style == UICollectionViewPagingLayoutStyleRotation) {
    return YES;
  }
...
- (NSArray<UICollectionViewLayoutAttributes *> *)layoutAttributesForElementsInRect:(CGRect)rect {
  if (self.style == UICollectionViewPagingLayoutStyleDefault) {
  ...
  if (self.style == UICollectionViewPagingLayoutStyleScale) {
  ...
  if (self.style == UICollectionViewPagingLayoutStyleRotation) {
    if (self.rotationRadius == UICollectionViewPagingLayoutRotationRadiusAutomatic) {
