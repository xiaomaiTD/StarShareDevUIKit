//
//  SSUIPieProgressView.m
//  StarShareDevUIKit
//
//  Created by BUBUKO on 2017/11/11.
...
@interface SSUIPieProgressLayer : CALayer
...
@implementation SSUIPieProgressLayer
...
@implementation SSUIPieProgressView

+ (Class)layerClass {
  return [SSUIPieProgressLayer class];
}
...
- (void)setProgress:(float)progress animated:(BOOL)animated {
  ...
  SSUIPieProgressLayer *layer = (SSUIPieProgressLayer *)self.layer;
...
- (SSUIPieProgressLayer *)progressLayer {
  return (SSUIPieProgressLayer *)self.layer;
}
@end
