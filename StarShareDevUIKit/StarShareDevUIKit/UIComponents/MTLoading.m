...
static NSString *kMTLoadingStrokeAnimationKey = @"mt.loading.stroke";
static NSString *kMTLoadingRotationAnimationKey = @"mt.loading.rotation";
...
- (void)startAnimating {
  ...
  [self.progressLayer addAnimation:animation forKey:kMTLoadingRotationAnimationKey];
  ...
  [self.progressLayer addAnimation:animations forKey:kMTLoadingStrokeAnimationKey];
...
- (void)stopAnimating {
  ...
  [self.progressLayer removeAnimationForKey:kMTLoadingRotationAnimationKey];
  [self.progressLayer removeAnimationForKey:kMTLoadingStrokeAnimationKey];
