...
typedef NS_OPTIONS(NSInteger, UIImageBorderPosition) {
  UIImageBorderPositionAll      = 0,
  UIImageBorderPositionTop      = 1 << 0,
  UIImageBorderPositionLeft     = 1 << 1,
  UIImageBorderPositionBottom   = 1 << 2,
  UIImageBorderPositionRight    = 1 << 3,
};
 ...
 *
 *  @return 处理完的图片
 *  @see imageWithScaleToSize:contentMode:scale:
 */
...
- (UIImage *)imageWithBorderColor:(UIColor *)borderColor
                      borderWidth:(CGFloat)borderWidth
                   borderPosition:(UIImageBorderPosition)borderPosition;
